...
*If you'd like more details on this topic, I highly suggest you to read this [great article from Ditto ETH](https://dittoeth.com/blog/exogenous).*
...
*If you'd like more details on TWAP check [this article by RareSkills](https://www.rareskills.io/post/twap-uniswap-v2)*
...
This means our stablecoin will be pegged to USDC (and its fluctuation), rather to USD which is not what we aimed for. If this is the case, this also means users can eventually extract value from our protocol/users, for example by arbitraging the difference between the mint/burn price and the pool price. 
