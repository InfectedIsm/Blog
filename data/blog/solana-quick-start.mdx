---
title: 'Enter the Fast Lane: The Essential to Start Auditing Solana Program'
date: '2024-11-12'
tags: ['solana', 'tutorial', 'guide']
images: ['/static/images/blog/solana-quick-start/solana_car_final.png']
draft: false
summary: This guide aims to provide the minimum knowledge required to start auditing Solana programs while learning Rust on the go, supported by extensive learning resources for deeper understanding.
---

![Enter the Fast Lane: The Essential to Start Auditing Solana Program](/static/images/blog/solana-quick-start/solana_car_final.png)
...
![Data and Program Accounts, source: https://solana.com/docs/core/accounts#data-account](/static/images/blog/solana-quick-start/1.png)
...
![Serialize and Deserializer](/static/images/blog/solana-quick-start/serializer.png)
...
Hopefully, that is not the case, and what happens is that data accounts created from a program (by a program) have a special type of address called a **Program Derived Address** (or **PDA**).  
PDAs are generated in a deterministic way by [hashing](https://www.geeksforgeeks.org/what-is-hashing/) the program's own address and any optional number of seeds (bytes values), and a bump (you can search for this one later, but its not important right now).

![PDA generation](/static/images/blog/solana-quick-start/pda.png)
...
![SPL Token Program and related accounts](/static/images/blog/solana-quick-start/2.png)
...
![different type of account ownership, source: https://solana.com/docs/core/accounts#data-account](/static/images/blog/solana-quick-start/5.png)
...
- [Rareskills: Solana RareSkills articles](https://www.rareskills.io/category/solana)
- [Rareskills: 60 Days of Solana (RareSkills)](https://www.rareskills.io/solana-tutorial)
- [Rareskills: Basic Rust for Solidity Developers](https://www.rareskills.io/post/rust-basic-syntax)
- [Understanding Solana for EVM developers](https://solana.com/developers/evm-to-svm)
- [Ackee Solana Developers courses](https://solana.com/developers/courses)
...
- [Helius: Solana Executive Overview](https://www.helius.dev/blog/solana-executive-overview)
- [Ottersec: Sample Public Audit Reports (select “Solana” as chain)](https://www.notion.so/a296e98838aa4fdb8f3b192663400772?pvs=21)
- [ImmuneBytes: Solana Attack Vectors](https://github.com/ImmuneBytes-Security-Audit/Blockchain-Attack-Vectors/tree/main/Solana%20Attack%20Vectors)
- [0xMacro: Awesome Solana Security (resources list)](https://github.com/0xMacro/awesome-solana-security)
