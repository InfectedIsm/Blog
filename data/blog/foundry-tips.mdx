...
date: '2024-07-16'
tags: ['tutorial', 'tools', 'bug-hunting', 'report', 'foundry']
images: ['/static/images/blog/foundry-tips/chest.png']
draft: false
...
By using wrapping your code inside a _\```diff ... ```_ code block you'll get these really practical colors:
